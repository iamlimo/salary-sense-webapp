      ...
      <div className="flex flex-col items-center justify-center h-[80vh] p-6">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 w-full max-w-2xl text-center">
          ...
          <p className="text-gray-600 mb-6 text-lg">
            We're currently building a comprehensive Pension management system
            to help you manage your workforce more efficiently. Stay tuned for
            exciting features including employee onboarding, document
            management, and detailed employee profiles.
          </p>
          {/*           
          ...
          <Button
            onClick={() => navigate("/")}
            className="bg-payroll-600 hover:bg-payroll-700"
          >
            Return to Dashboard
          </Button>
        </div>
